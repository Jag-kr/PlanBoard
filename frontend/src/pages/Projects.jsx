...
export default function Projects() {
  ...
  const handleDelete = async () => {
    ...
    } catch { toastError('Failed to delete project.'); }
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description={canManage ? "Create your first project to get started." : "Ask an admin or manager to create a project."}
          action={canManage && (
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-50">
                <span className="text-xs text-gray-400">{project.taskCount ?? 0} task{project.taskCount !== 1 ? 's' : ''}</span>
                {canManage && (
                  <button
