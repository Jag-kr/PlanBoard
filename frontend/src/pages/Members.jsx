...
export default function Members() {
  ...
  const fetchMembers = async () => {
    ...
    } catch { toastError('Failed to load members.'); }
    finally { setLoading(false); }
  };

  useEffect(() => { fetchMembers(); }, [activeWorkspace?.id]);
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {loading ? (
          ...
          <EmptyState icon="👥" title="No members" description="Invite your team to get started." />
        ) : (
      ...
      <Modal isOpen={showInvite} onClose={() => setShowInvite(false)} title="Invite member" size="sm">
        <form onSubmit={handleInvite} className="space-y-4">
          <div>
            ...
            <input autoFocus required type="email" value={inviteForm.email}
