...
export default function TaskCard({ task, onClick, onDragStart, onDragEnd }) {
  ...
  return (
    <div
      ...
      className="bg-white rounded-lg shadow-sm hover:shadow-md border border-gray-100 hover:border-blue-200 p-3 cursor-pointer transition-all duration-150 select-none group"
    >
      {/* Priority badge */}
