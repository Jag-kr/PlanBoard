...
const getWorkspaceId = async (projectId) => {
  const project = await Project.findByPk(projectId, { attributes: ['workspace_id'] });
...
const createTask = async (req, res, next) => {
  try {
    ...
    emitToWorkspace(project.workspace_id, 'task:created', { task: fullTask, workspaceId: project.workspace_id });
...
const updateTask = async (req, res, next) => {
  try {
    ...
    emitToWorkspace(workspaceId, 'task:updated', { task: updatedTask, workspaceId });
